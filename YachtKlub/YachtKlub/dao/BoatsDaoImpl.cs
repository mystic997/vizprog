...
namespace YachtKlub.dao
{
    class BoatsDaoImpl : BaseDao<BoatsEntity>, BoatsDao
    {
        public List<BoatsEntity> GetAllBoats()
        {
            ...
            RentRequestsDao rentRequestsDao = new RentRequestsDaoImpl();
            ...
            for (int i = 0; i < 15; i++)
            {
                ...
                templateBoat.BoatRentals = boatRentalsDao.GetAllBoatRents();/*Ide nem ez kell, csak az ami ehhez a hajóhoz tartozik*/
                templateBoat.RentRequests = rentRequestsDao.GetAllRentRequests();/*Ide nem ez kell, csak az ami ehhez a hajóhoz tartozik*/
                TemplateBoatRentals.Add(templateBoat);
            }
        ...
        public BoatsEntity GetBoatsById(int v)
        {
